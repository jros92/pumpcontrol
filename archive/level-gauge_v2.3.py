...
def send_data_to_thingspeak(url, key, level, pump_state, log_file_path_abs):
  ...
  """
    ...
    try:
        ...
        log_str = 'Error sending data to Thingspeak: Server could not fulfill the request. Error code: ' + e.code
    except urllib2.URLError as e:
        log_str = 'Error sending data to Thingspeak: Failed to reach server. Reason: ' + e.reason
    except:
